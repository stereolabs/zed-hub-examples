...
if [[ $reset_variables -eq 1 ]]; then
        ...
        do
            case $opt in
                ...
                "4.4")
                    ...
                    ;;
                *)
                    echo "Invalid option. Type \"1\" for Jetpack 4.3 and \"2\" for Jetpack 4.4."
                    ;;
            esac
        done
    else
    ...
    read -p "Which version of the sl_iot library your application will be using (ex : 0.22.0)?" choice
