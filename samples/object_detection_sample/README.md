...
The **Object detection** is enabled with `enableObjectDetection`. 
...
- **Video events** are defined exactly in the same way than in [`tutorial_06_video_event`](/tutorials/tutorial_06_video_event/README.md)
